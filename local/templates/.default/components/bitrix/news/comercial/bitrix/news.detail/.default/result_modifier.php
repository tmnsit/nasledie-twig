...
mpr($arResult,false,'js');
if($arResult['DISPLAY_PROPERTIES']['PLAN']['VALUE']){
    $newsDetail['download']['target'] = 'blank';
    $newsDetail['download']['text'] =  'скачать презентацию ' . $arResult['NAME'];
    $newsDetail['download']['href'] = $arResult['DISPLAY_PROPERTIES']['PLAN']['VALUE'];
}
