...
class Version20211129155318 extends Version
{
  ...
  'ACTIVE' => 'Y',
  'SORT' => '500',
  'LIST_PAGE_URL' => '#SITE_DIR#/payment/',
  'DETAIL_PAGE_URL' => '#SITE_DIR#/payment/#ELEMENT_CODE#/',
  'SECTION_PAGE_URL' => '',
  'CANONICAL_PAGE_URL' => '',
  'PICTURE' => NULL,
  'DESCRIPTION' => '<p>
	 Продажа недвижимости в ЖК «Квартал лета» осуществляется на основе эскроу-счетов (ФЗ-214). Банком-партнёром, осуществляющим открытие эскроу-счетов, является Сбербанк.
</p>
<p>
	 Вы можете выбрать наиболее удобный для вас способ покупки:
</p>',
  ...
  array (
    ...
    'PROPERTY_TITLE_EXTRA' => 'Заголовок',
